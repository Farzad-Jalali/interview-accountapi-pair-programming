...
type PaymentSubmissionAmendment struct {
	...
	// data
	Data *PaymentSubmissionUpdate `json:"data,omitempty"`
}
...
func (m *PaymentSubmissionAmendment) validateData(formats strfmt.Registry) error {
...
func (m *PaymentSubmissionAmendment) UnmarshalBinary(b []byte) error {
	var res PaymentSubmissionAmendment
