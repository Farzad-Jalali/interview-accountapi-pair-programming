...
func init() {
	...
	if err := json.Unmarshal([]byte(`["payment_admissions","payment_batches","payment_submissions","payment_submission_validations","payments","return_admissions","return_reversals","return_reversal_admissions","return_submissions","return_submission_validations","returns","reversal_admissions","reversal_submissions","reversal_submission_validations","reversals","limits","positions","payment_defaults"]`), &res); err != nil {
		panic(err)
	}
	for _, v := range res {
